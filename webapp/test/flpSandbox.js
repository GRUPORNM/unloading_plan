		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#unloadingplan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"unloadingplan-display": {
								"semanticObject": "unloadingplan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=unloadingplan",
									"url": sap.ui.require.toUrl("unloadingplan")
								}
							}
						}
					}
